...
def align_translations(english_file, french_file, output_file):
    ...
    strings_en_fr_xliff = os.path.join(base_dir, 'test-files', 'strings_en_fr_.xliff')
...
xml_path_en = os.path.join(base_dir, 'test-files', 'xml_strings_en.xml')
xml_path_fr_random = os.path.join(base_dir, 'test-files', 'xml_strings_fr_misAligned.xml')
xml_path_fr_aligned = os.path.join(base_dir, 'test-files', 'xml_strings_fr_aligned.xml')
